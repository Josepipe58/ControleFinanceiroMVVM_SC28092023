...
namespace BancoDeDados.ContextoDoBancoDeDados
{
    public class Contexto
    {
        public static string Banco { get; set; } = "BancoDeTestes"; //= "Financeiro_2020_2025"; //"Financeiro_2020_2025";

        private readonly SqlParameterCollection _sqlParameterCollection = new SqlCommand().Parameters;
        public Contexto(string banco)
        {
            Banco = banco;
        }
        public Contexto() { }
