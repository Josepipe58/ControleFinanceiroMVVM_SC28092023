...
{
    public class ContextoNomeDeBancos
    {
        ...
        public static SqlConnection CriarConexao()
        {
            ...
            try
            {
                conexao.ConnectionString = "Data Source=JOSEPIPE-PC\\FINANCEIRO;Initial Catalog=NomeDosBancoDeDados;Integrated Security=True;" +
